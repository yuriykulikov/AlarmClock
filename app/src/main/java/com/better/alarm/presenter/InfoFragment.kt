...
class InfoFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val viewFactory = ViewSwitcher.ViewFactory {
            requireActivity().layoutInflater.inflate(R.layout.info_fragment_text, container, false) as TextView
        }

        val remainingTime: TextSwitcher = view.findViewById<TextSwitcher>(R.id.info_fragment_text_view_remaining_time).apply {
